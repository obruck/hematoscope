...
for plugin in plugins:
    ...
    for file in files:
        ...
        for index, entry in enumerate(data):
            ...
            # Skip entries with the string "Conference abstract"
            if "Conference abstract" in entry.get("your_field_name_here", ""):
                log("Skipped entry with the string 'Conference abstract'", 3)
                continue
